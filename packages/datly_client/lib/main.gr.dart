...
import 'package:datly_client/main.dart' as _i3;
import 'package:datly_client/screens/error.dart' as _i1;
import 'package:datly_client/screens/login.dart' as _i2;
import 'package:datly_client/screens/upload.dart' as _i4;
...
/// generated route for
/// [_i4.Upload2Page]
class Upload2Route extends _i5.PageRouteInfo<void> {
  const Upload2Route({List<_i5.PageRouteInfo>? children})
    : super(Upload2Route.name, initialChildren: children);

  static const String name = 'Upload2Route';

  static _i5.PageInfo page = _i5.PageInfo(
    name,
    builder: (data) {
      return const _i4.Upload2Page();
    },
  );
}
